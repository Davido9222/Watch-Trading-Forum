...
// Seeds starter posts only if the collection is empty.
const SEED_POSTS = [
  {
    ...
    authorId: 'owner-1', authorName: 'SiteOwner', authorAvatar: '/avatar-owner.png',
    ...
    viewCount: 1250, metaTitle: 'What Should Your First Watch Be?',
  ...
  },
  {
    ...
    viewCount: 892, metaTitle: 'Understanding Rolex Reference Numbers',
  ...
  },
  {
    ...
    viewCount: 2103, metaTitle: 'Investment Watches: What Holds Value?',
...
router.post('/seed', auth, requireRole('owner'), async (req, res) => {
  try {
    ...
    res.status(201).json({ message: `Seeded ${inserted.length} posts`, posts: inserted.map(toClient) });

// ============================================
// SHOUTBOX PAGE
// Live group chat with rate limiting
// ============================================
  ...
  return (
    <div className={`flex gap-3 mb-3 ${isCurrentUser ? 'flex-row-reverse' : ''}`}>
      <Avatar className="h-8 w-8 flex-shrink-0">
        ...
        <AvatarFallback className={message.authorRole === 'owner' ? 'bg-yellow-500 text-white' : message.authorRole === 'admin' ? 'bg-red-600 text-white' : 'bg-gray-300'}>
...
// ============================================
// MAIN SHOUTBOX COMPONENT
// ============================================
export const ShoutboxPage: React.FC = () => {
  const { messages, sendMessage, canSendMessage, clearMessages } = useShoutboxStore();
  ...
  useEffect(() => {
    const updateRateLimit = () => {
      ...
      setRateLimitInfo({
        ...
        secondsUntilReset: info.secondsUntilReset,
      });
    };
  ...
  const handleSend = (e?: React.FormEvent) => {
    ...
    const result = sendMessage(inputMessage, currentUser);
          ...
          <div className="lg:col-span-3">
            <Card className="h-[600px] flex flex-col">
              ...
              <div className="p-4 border-t bg-gray-50">
                {status && (
                  <Alert className={`mb-3 ${status.type === 'error' ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'}`}>
